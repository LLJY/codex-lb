...
@pytest.mark.asyncio
async def test_stream_http_504_timeout_code_retries_same_account_then_succeeds(async_client, monkeypatch):
    await _import_account(async_client, "acc_http504_timeout", "http504-timeout@example.com")
